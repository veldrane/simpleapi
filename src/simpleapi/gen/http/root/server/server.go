...
// Server lists the root service endpoint HTTP handlers.
type Server struct {
	Mounts  []*MountPoint
...
// New instantiates HTTP handlers for all the root service endpoints using the
...
func (s *Server) Service() string { return "root" }
...
// Mount configures the mux to serve the root endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountDefaultHandler(mux, h.Default)
}

// MountDefaultHandler configures the mux to serve the "root" service "default"
// endpoint.
...
// calls the "root" service "default" endpoint.
func NewDefaultHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "root")
		var err error
